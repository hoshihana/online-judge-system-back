...
public class RecordController {
    ...
    @GetMapping("/status")
    public ArrayList<SubmitAcceptAmountPair> getAllRecentSubmitAcceptAmount(@Range(min = 1, max = 31, message = "查询天数需在1到31天之间") Integer dayLimit) {
        return recordService.getAllRecentSubmitAcceptAmount(dayLimit);
    }
}
